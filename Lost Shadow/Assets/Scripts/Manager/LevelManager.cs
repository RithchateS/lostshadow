...
namespace Manager
{
    ...
    public class LevelManager : MonoBehaviour
    {
        ...
        [Header("Startup")] [SerializeField] private Transform startPos;
        ...
        [Header("Camera")] public GameObject freeCamera;
        public GameObject mainCineCamera;
        public GameObject objectCamera;

        [Header("MapBounds")] [SerializeField] private CinemachineConfiner2D cameraBounds;
        [SerializeField] private Collider2D mapBoundsShadow;
        [SerializeField] private Collider2D mapBoundsLight;

        [Header("Canvas Object")] public TMP_Text shiftCountText;
        ...
        [Header("Others")] [SerializeField] private GameObject _player;
        ...
        /// <summary>
        /// Check Before Start The Scene.
        /// Usually Call in Start().
        /// </summary>
        void CheckBeforeStart()
        {
            if (SoundManager.Instance == null)
            {
                ...
                Debug.LogError("You need to start from persistant scene");
            }
            if (GameSaveManager.Instance != null)
            {
                GameSaveManager.Instance.SaveGame();
            }
            Debug.Log("Start Level Complete");
        }
    }
}
